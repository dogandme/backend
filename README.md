...
>다른 사용자들과 공유하며 소통의 활성화를 제공 합니다.
>
> Spring Boot와 Spring Data JPA를 사용하여 기본적인 REST API를 구현하고,\
> AWS와 S3를 활용해 서버를 배포하였습니다. \
> 또한, GitHub Actions를 이용해 CI/CD 자동 배포를 설정하였습니다.
...
[//]: # (![Image]&#40;https://github.com/user-attachments/assets/32dcc9fb-7851-46be-9014-5e87189e7628&#41;)
...
### 인프라
<a href="https://github.com/msdio/stackticon"><img src="https://firebasestorage.googleapis.com/v0/b/stackticon-81399.appspot.com/o/images%2F1740452776285?alt=media&token=cd606a52-a567-4149-8973-7881c02c012c" alt="stackticon" /></a>

### 협업 Tools
<a href="https://github.com/msdio/stackticon"><img src="https://firebasestorage.googleapis.com/v0/b/stackticon-81399.appspot.com/o/images%2F1740549798262?alt=media&token=5587bf19-531b-43e6-b61d-f1f9bb3a6d95" alt="stackticon" /></a>



[//]: # (22)

[//]: # ([//]: # &#40;<a href="https://github.com/msdio/stackticon"><img src="https://firebasestorage.googleapis.com/v0/b/stackticon-81399.appspot.com/o/images%2F1740380111720?alt=media&token=72fe66a2-4a08-4227-b825-94dfbc19044a" alt="stackticon" /></a>&#41;)

[//]: # (<a href="https://github.com/msdio/stackticon"><img src="https://firebasestorage.googleapis.com/v0/b/stackticon-81399.appspot.com/o/images%2F1740381433756?alt=media&token=007097c9-bbbf-4d93-bee5-477a8a518527" alt="stackticon" /></a>)
...
<table align="center"> <!-- 팀원 표 -->
  <tr>
   ...
   <th>
      [ Jira ]      <br/>
GitHub와 Jira를 연동하여 형상 관리, 이슈 추적 및 프로젝트 진행 사항을 기록
   </th>
   </tr>
  <tr>
   <td align="left" width="500px" class="Notion">
      <img src="https://github.com/user-attachments/assets/34d92f56-7979-47b9-9344-3b1fbc8d9530"/>
  <img src="https://github.com/user-attachments/assets/c9246198-bad1-4fa5-ae0c-15b8f2fd96dc"/>
...
## API 명세서
API 문서는 [Postman 공유 링크](https://documenter.getpostman.com/view/26924668/2sAXqndjDZ)를 통해 확인할 수 있습니다.
...
| **pets**    | 펫 기능     | 펫 정보 조회, 수정, 업로드 등 펫 정보 관리 기능                         |
| **follows** | 팔로우 기능   | 사용자 간 팔로우/언팔로우, 팔로워/팔로잉 목록 조회 등 소셜 기능 관련 기능           |
| **map**     | 지도 관련 기능 | 위도 경도 범위 검색,지도 표시, 지도 내 마커 클러스터링 등 지도 관련 기능           |
| **marking** | 마킹 기능    | 좋아요, 즐겨찾기 ,마킹 추가, 조회, 수정 및 삭제 등 마킹 관련 기능              |
